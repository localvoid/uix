...
// 2015-03-28T09:55:09.421Z

part of uix.example.hello.main;

// **************************************************************************
// Generator: UixGenerator
// Target: class SvgIcon
// **************************************************************************

SvgIcon createSvgIcon([dynamic data, List<VNode> children, Component parent]) {
  return new SvgIcon()
    ..parent = parent
    ..data = data
    ..children = children;
}
VNode vSvgIcon({dynamic data, Object key, String type,
    Map<String, String> attrs, Map<String, String> style, List<String> classes,
    List<VNode> children}) => new VNode.component(createSvgIcon,
